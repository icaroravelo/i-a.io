...
const AutomationPage = () => {
    return (
        <div className='flex flex-col gap-16 md:gap-24 p-[2rem]'>
            <h1 className='animate-in text-center md:text-left text-3xl font-bold tracking-tight text-sky-800'>Automação</h1>
            ...
            <div className='flex flex-col gap-8'>
                {automationProjects.map((automation) => (
                    ...
                    >
                        ...
                        <Image
                            src={automation.image} alt={automation.name} width={500} height={500} className='mx-auto'    
                        />
